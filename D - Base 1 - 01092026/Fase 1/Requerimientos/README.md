...
5. **MÓDULO 5: Control y Gestión de Asistencia de Estudiantes** (`RF-AST-01` al `RF-AST-05`, incluye control de portería / "Wachiman")
...
8. **MÓDULO 8: Registro, Flujo y Seguimiento de Calificaciones en Tiempo Real** (`RF-NOT-01` al `RF-NOT-07`)
9. **MÓDULO 9: Mapas de Calor y Análisis Visual del Rendimiento y Asistencia** (`RF-CAL-01` al `RF-CAL-04`)
10. **MÓDULO 10: Monitoreo Institucional, Dashboards y Alertas Tempranas** (`RF-MON-01` al `RF-MON-05`)
11. **MÓDULO 11: Emisión de Reportes, Libretas y Documentación Escolar** (`RF-REP-01` al `RF-REP-05`)
